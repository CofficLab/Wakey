...
class HydrationReminderOverlayWindow: NSWindow {
    ...
    private func setupWindow() {
        ...
        let gradientView = HydrationGradientView()
...
private struct HydrationGradientView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                Text(String(localized: "Hydration", table: "HydrationReminder"))
                    .font(.system(size: 32, weight: .bold))
                    .foregroundColor(.primary)
                Text(String(localized: "Don't forget to drink some water!", table: "HydrationReminder"))
                    .font(.system(size: 18))
