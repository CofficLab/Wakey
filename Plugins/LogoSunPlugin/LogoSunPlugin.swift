...
/// Logo Plugin: 永恒太阳
actor LogoSunPlugin: SuperPlugin, SuperLog {
    ...
    nonisolated(unsafe) static var id: String = "LogoSunPlugin"

    static let navigationId = "\(id).settings"

    nonisolated(unsafe) static var displayName: String = String(localized: "永恒太阳", table: "Logo", comment: "Name of the logo plugin")

    nonisolated(unsafe) static var description: String = String(localized: "Provide sun logo variant", table: "Logo", comment: "Description of what the Logo plugin does")
    ...
    static let shared = LogoSunPlugin()
