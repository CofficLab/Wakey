...
/// Logo Plugin: 禁止睡眠
actor LogoNoSleepPlugin: SuperPlugin, SuperLog {
    ...
    nonisolated(unsafe) static var id: String = "LogoNoSleepPlugin"

    static let navigationId = "\(id).settings"

    nonisolated(unsafe) static var displayName: String = String(localized: "禁止睡眠", table: "Logo", comment: "Name of the logo plugin")

    nonisolated(unsafe) static var description: String = String(localized: "Provide no sleep logo variant", table: "Logo", comment: "Description of what the Logo plugin does")
    ...
    static let shared = LogoNoSleepPlugin()
