...
/// Logo Plugin: 脉冲心跳
actor LogoPulsePlugin: SuperPlugin, SuperLog {
    ...
    nonisolated(unsafe) static var id: String = "LogoPulsePlugin"

    static let navigationId = "\(id).settings"

    nonisolated(unsafe) static var displayName: String = String(localized: "脉冲心跳", table: "Logo", comment: "Name of the logo plugin")

    nonisolated(unsafe) static var description: String = String(localized: "Provide pulse logo variant", table: "Logo", comment: "Description of what the Logo plugin does")
