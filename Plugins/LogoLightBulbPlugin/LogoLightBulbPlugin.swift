...
/// Logo Plugin: 智能光源
actor LogoLightBulbPlugin: SuperPlugin, SuperLog {
    ...
    nonisolated(unsafe) static var id: String = "LogoLightBulbPlugin"

    static let navigationId = "\(id).settings"

    nonisolated(unsafe) static var displayName: String = String(localized: "智能光源", table: "Logo", comment: "Name of the logo plugin")

    nonisolated(unsafe) static var description: String = String(localized: "Provide lightbulb logo variant", table: "Logo", comment: "Description of what the Logo plugin does")
    ...
    static let shared = LogoLightBulbPlugin()
