...
在你的 `Package.swift` 中添加 WakeryUI 依赖：
...
2. 选择 **Local Package** 并导航到 WakeryUI 目录
3. 添加到你的项目目标
...
WakeryUI 采用 MIT 许可证 - 详见 [LICENSE](LICENSE) 文件
