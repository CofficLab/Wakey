...
/// 将 ``WakeryAppChromeTheme`` 映射为组件库使用的 ``WakeryUITheme``。
public struct ChromeToUIThemeAdapter: WakeryUITheme {
    private let chrome: any WakeryAppChromeTheme

    public init(chrome: any WakeryAppChromeTheme) {
        self.chrome = chrome
    }
