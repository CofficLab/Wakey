...
/// 登记到 ``WakeryUIThemeRegistry`` 的完整主题贡献。
public struct WakeryUIThemeContribution: Identifiable {
    ...
    public let chromeTheme: any WakeryAppChromeTheme
    public let editorThemeId: String
    public let uiTheme: (any WakeryUITheme)?
    public let attachments: ThemeAttachments

    public init(
        sortKey: ThemeSortKey,
        chromeTheme: any WakeryAppChromeTheme,
        editorThemeId: String,
        uiTheme: (any WakeryUITheme)? = nil,
