...
public struct ThemeCatalog: Equatable {
    public let themes: [WakeryUIThemeContribution]
    public let selectedId: String

    public init(themes: [WakeryUIThemeContribution], selectedId: String) {
        self.themes = themes
        self.selectedId = selectedId
    }

    public var selected: WakeryUIThemeContribution? {
