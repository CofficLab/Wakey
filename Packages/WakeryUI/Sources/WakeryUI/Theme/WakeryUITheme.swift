...
public extension WakeryUITheme {
...
public struct WakeryDefaultTheme: WakeryUITheme {
    public let id = "wakery-default"
    public let name = "Wakery Default"
...
@MainActor
public final class WakeryUIThemeStore: ObservableObject {
    public static let shared = WakeryUIThemeStore()

    @Published public private(set) var theme: any WakeryUITheme

    private init(theme: any WakeryUITheme = WakeryDefaultTheme()) {
        self.theme = theme
    }

    public func setTheme(_ theme: any WakeryUITheme) {
        self.theme = theme
    }
}
...
@MainActor
public func setTheme(_ theme: any WakeryUITheme) {
    WakeryUIThemeStore.shared.setTheme(theme)
}

@MainActor
public var currentTheme: any WakeryUITheme {
    WakeryUIThemeStore.shared.theme
}

@propertyWrapper
@MainActor
public struct WakeryTheme: DynamicProperty {
    @ObservedObject private var store = WakeryUIThemeStore.shared

    public init() {}

    public var wrappedValue: any WakeryUITheme {
        store.theme
    }
}
