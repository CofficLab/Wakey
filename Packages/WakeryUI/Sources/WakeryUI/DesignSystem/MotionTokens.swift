...
extension DesignTokens {
    /// Motion tokens keep interaction timing consistent across WakeryUI.
    enum Motion {
        ...
        static func enabled(_ animation: Animation, preference: WakeryMotionPreference) -> Animation? {
            preference.allowsMotion ? animation : nil
        }

        static func listEnabled(_ animation: Animation, preference: WakeryMotionPreference) -> Animation? {
...
public enum WakeryMotion {
    ...
    public static func enabled(_ animation: Animation, preference: WakeryMotionPreference) -> Animation? {
        DesignTokens.Motion.enabled(animation, preference: preference)
    }

    public static func listEnabled(_ animation: Animation, preference: WakeryMotionPreference) -> Animation? {
