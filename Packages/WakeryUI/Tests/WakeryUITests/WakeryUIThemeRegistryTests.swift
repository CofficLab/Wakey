...
private struct MockChromeTheme: WakeryAppChromeTheme {
...
private func contribution(
    ...
    return WakeryUIThemeContribution(
...
struct WakeryUIThemeRegistryTests {
    @Test
    @MainActor
    func replaceAllEmptyThrowsNoThemesRegistered() {
        let registry = WakeryUIThemeRegistry()
    ...
    func selectUpdatesChromeAndUIStore() throws {
        ...
        #expect(WakeryUIThemeStore.shared.theme.id == "second")
    }
    ...
    func resolvedEditorThemeIdUsesChromeHook() throws {
        struct AdaptiveChrome: WakeryAppChromeTheme {
