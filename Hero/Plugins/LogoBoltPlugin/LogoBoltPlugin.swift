...
/// Logo Plugin: 能量闪电
actor LogoBoltPlugin: SuperPlugin, SuperLog {
    ...
    nonisolated(unsafe) static var id: String = "LogoBoltPlugin"

    static let navigationId = "\(id).settings"

    nonisolated(unsafe) static var displayName: String = String(localized: "能量闪电", table: "Logo", comment: "Name of the logo plugin")

    nonisolated(unsafe) static var description: String = String(localized: "Provide bolt logo variant", table: "Logo", comment: "Description of what the Logo plugin does")
